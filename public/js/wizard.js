...
Step = function(id, step_def){
	...
	this.visible_if = step_def.visible_if;
	this.finish_func = step_def.finish_func;
	this.start_func = step_def.start_func;
	this.completed_if = step_def.completed_if;
...
var Measure = function(measure_id){
	...
	this.option_filter = measure_def.option_filter;
	this.visible_if = measure_def.visible_if;
